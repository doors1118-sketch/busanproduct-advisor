...
sftp = ssh.open_sftp()
local_test = 'run_stress_test.py'
remote_test = '/root/advisor/run_stress_test.py'
...
nohup {python_path} run_stress_test.py > stress_test.log 2>&1 &
'''
ssh.exec_command(cmd)
print("Stress test script started in background.")
ssh.close()
