...
|:---|:---|:---|:---|:---|
| 필수 슬롯 누락 | `source_context.buyer_type_confidence == "low"` | `insufficient_data` | `["buyer_type"]` 추가 | `buyer_type_assumed=True` 할당 후, Answer Builder가 사용자에게 슬롯 확인을 유도하도록 전달 |
...
|:---|:---|:---|:---|:---|
| 단가계약(MAS) 적용 | `route_context.overlay_applied == True` | `requires_pps_delegated_contract` | `True` | - (Item 판단에 위임) |
