...
- `review_candidate`: "제시된 조건에 대해 세부 검토가 가능한 대상입니다."
...
- **silent**: 별도 섹션을 생성하지 않고, 요약 또는 주의사항 섹션 내에 "품목별 특수 자격 조건이 존재할 수 있으니 유의 바랍니다." 수준의 1줄 보조 문구만 허용합니다.
