...
def assemble_prompt(
    ...
    if "company_search" in guardrails:
        ...
        parts.append("\n[⚠️ 혁신제품/우선구매 수의계약 안내 지침]\n")
        parts.append("특정 제품(혁신제품, 기술개발제품 등)에 대해 '금액 제한 없이 수의계약이 가능하다' 또는 '수의계약이 가능합니다'라고 절대 단정짓지 마세요.\n")
        parts.append("반드시 '해당 요건(지정 유효기간, 혁신장터 등록 여부 등)을 확인한 후 수의계약 검토가 가능하다'고 유보적으로 답변하세요.\n")
