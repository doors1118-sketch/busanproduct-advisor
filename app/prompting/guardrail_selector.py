...
_LABEL_TO_GUARDRAIL = {
    ...
    "contract_review": "common_procurement",
    "local_purchase_support": "common_procurement",
    "procurement_route_review": "common_procurement",
    "legal_explanation": "common_procurement",
