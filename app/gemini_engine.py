...
def _security_service_regional_lines() -> list[str]:
    labels = _local_supplier_numeric_labels()
    return [
        "### 2. 청사 경비용역은 `지역제한`보다 먼저 `경비업 허가`를 봐야 합니다",
        "- 청사 경비는 인력이 현장에 상주하고 출입통제, 순찰, 도난ㆍ화재 예방, 비상 대응을 수행하는 용역입니다.",
