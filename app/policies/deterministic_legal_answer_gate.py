...
def _innovation_product_purchase_review_answer() -> str:
    return "\n".join([
        ...
        "일반 소액수의 한도에만 묶어 판단하는 사안은 아니지만, 지정·인증 상태가 맞는지 확인하지 않고 성급하게 계약 결론을 내리면 감사 리스크가 큽니다.",
        "",
        "### 1. 수의계약과 우선구매의 차이",
        "| 구분 | 수의계약 | 우선구매 |",
        "|---|---|---|",
        ...
        "| 주요 근거 | 지방자치단체는 「지방계약법 시행령」 제25조의 수의계약 사유, 국가기관은 「국가계약법 시행령」 제26조, 공기업·준정부기관은 「공기업·준정부기관 계약사무규칙」과 준용 규정 | 「조달사업법」의 혁신제품 제도, 「중소기업제품 구매촉진 및 판로지원에 관한 법률」 및 기술개발제품 우선구매 관련 고시·운영규정 |",
        ...
        "|---|---|---|",
        "| 혁신제품 | 혁신제품 지정 여부, 지정 유효기간, 혁신장터·조달계약 등록, 제품명·규격 일치 확인 | 혁신제품 구매실적, 시범구매·혁신조달 정책과 연결되는지 확인 |",
        ...
        "",
        "### 3. 금액 질문에 대한 실무 답",
        "- 결론은 `금액만으로 배제하지 않는다`입니다. 혁신제품·기술개발제품 특례는 일반 소액수의 한도와 다른 축의 수의계약 사유이기 때문입니다.",
        "- 다만 `혁신제품이라는 명칭`, `GS·NEP·NET 같은 인증명`, `부산업체 제품`이라는 이유만으로 충분하지 않습니다. **지정·인증 유효성, 제품명·규격 일치, 조달등록 상태, 직접생산확인 필요 여부, 기관 적용 법령**을 같이 봐야 합니다.",
        "- 고액이거나 대체 가능한 제품이 많은 경우에는 수의계약 사유서에 `왜 이 지정 제품이어야 하는지`, `경쟁입찰보다 이 경로가 적정한 이유`, `가격 적정성 검토`를 남기는 것이 안전합니다.",
        "",
        "### 4. 부산업체 지원과 연결할 때",
        ...
        "",
        "정리하면, **수의계약은 계약방법이고 우선구매는 정책목표입니다.** 두 근거를 섞지 말고, 제품의 지정·인증 상태를 먼저 확인한 뒤 수의계약 사유와 우선구매 실적을 각각 문서화하세요.",
    ])
