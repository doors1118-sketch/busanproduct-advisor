...
_ITEM_SYNONYM_GROUPS: list[dict] = [
    ...
    },
    {
        ...
        "search_terms": ["비디오프로젝터", "빔프로젝터", "빔프로젝트", "프로젝터", "슬라이드프로젝터"],
        "aliases": ["비디오프로젝터", "비디오 프로젝터", "빔프로젝터", "빔 프로젝터", "빔프로젝트", "빔 프로젝트", "프로젝터"],
        "negative_contexts": ["영사용스크린", "영사대", "영상감시장치", "영상회의시스템", "영상정보디스플레이장치"],
    },
    {
        "canonical_name": "배전반",
