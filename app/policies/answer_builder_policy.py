...
def build_simple_company_search_answer(generation_meta: dict, has_candidates: bool = True) -> str:
    ...
    template += (
        ...
        "- 제조·직접생산 범위, 조달등록, 종합쇼핑몰/MAS 등록, 인증 상태, 정책기업 지위를 원자료로 확인하세요.\n"
        "- 설치나 연동이 포함되는 품목은 정보통신공사업, 소프트웨어사업자 등 수행 역량도 함께 확인하세요.\n"
        "- 이 표는 후보 발굴용이며, 업체 적격성이나 계약 가능 여부 판단은 포함하지 않습니다."
    )
